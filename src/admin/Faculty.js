...
export default function Faculty() {
  ...
  const [ob1, setob1] = useState({ phone: "", branch: "", name: "", email: "", password: "" })
  const [ob2, setob2] = useState({ id: 0, phone: "", branch: "", name: "", email: "", password: "" })
  ...
  return (
    <div className='wrapper'>
      ...
      <div className='form'>
        ...
        <input placeholder='branch' name='branch' value={ob1.branch} onChange={handleChange1} />
      ...
      {ob2?.id > 0 && <div className='form'>
        ...
        <input placeholder='branch' name='branch' value={ob2.branch} onChange={handleChange2} />
        <button onClick={update}>update</button>
      </div>
      }
      <h3>All faculty : {a.length}</h3>
